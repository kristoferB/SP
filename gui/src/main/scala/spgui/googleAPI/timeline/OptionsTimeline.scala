...
trait OptionsTlTrait extends OptionsTrait {
  ...
  //def toObject(options: OptionsTimeline): js.Object
}
...
class OptionsTimeline (
                ...
                override val colors:                    Array[String] = null,
                ...
                override val timeline: Timeline =       new Timeline(),
                override val tooltip: Tooltips =        new Tooltips()
              )extends OptionsTlTrait {

  def this() = this(0,0)
  // todo: implement toObject
  // argument: a options timeline
