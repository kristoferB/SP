...
object WidgetList {
  val list =
    List[(String, SPWidgetBase => ReactElement, Int, Int)](
      ...
      ("Statusdiagram (medicin gul)", widgets.ChangeMedicineYellowStatusWidget(), 4, 1),
      ...
      ("Platsdiagram (medicin gul)", widgets.ChangeMedicineYellowPlaceWidget(), 4, 1),
      ...
      ("Patientkort (medicin gul)", widgets.ChangeMedicineYellowPatientCardsWidget(), 8, 8),
