...
object WidgetList {
  val list =
    List[(String, SPWidgetBase => ReactElement, Int, Int)](
      ...
      ("Triagediagram (medicin gul)", widgets.ChangeMedicineYellowTriageWidget(), 3, 3),
      ...
      ("Statusdiagram (medicin gul)", widgets.ChangeMedicineYellowStatusWidget(), 3, 1),
      ...
      ("Platsdiagram (medicin gul)", widgets.ChangeMedicineYellowPlaceWidget(), 3, 1),
      ...
      ("Patientkort (medicin gul)", widgets.ChangeMedicineYellowPatientCardsWidget(), 7, 5),
