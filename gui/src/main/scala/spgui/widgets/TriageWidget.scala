...
svg.append("text")
 ...
 def getTeam(s: String): String = {
   s match {
     case "medicin gul" => "MEDICIN GUL"
     case "medicin blå" => "MEDICIN BLÅ"
     case "medicin" => "HELA MEDICIN"
     case "streamteam" => "STREAMTEAM"
     case "stream" => "STREAMTEAM"
