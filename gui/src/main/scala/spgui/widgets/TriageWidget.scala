...
object TriageWidget {
  ...
  */
  ...
  def checkHeight(d: Double): Double = {
  if(d > 0 && d < (35.0/450)*width){return (35.0/450)*width}
  else{return d}
}
...
g.append("line")
 ...
 .attr("stroke", colorLines)
  ...
  g.append("rect")
  .attr("x", distance)
  .attr("y", height - checkHeight(length("NotTriaged") * scaleBars) - moveEverything)
  .attr("width", barWidth)
  .attr("height", checkHeight(length("NotTriaged") * scaleBars))
...
svg.append("text")
  ...
  // ----------- Graf två, Blå  -------------
   g.append("rect")
 	...
 	.attr("y", height - checkHeight(length("Blue") * scaleBars) - moveEverything)
 	.attr("width", barWidth)
 	.attr("height", checkHeight(length("Blue") * scaleBars))
   ...
   g.append("rect")
 	...
 	.attr("y", height - checkHeight(length("Green") * scaleBars)  - moveEverything)
 	.attr("width", barWidth)
 	.attr("height", checkHeight(length("Green") * scaleBars))
   ...
   g.append("rect")
 	...
 	.attr("y", height - checkHeight(length("Yellow") * scaleBars)  - moveEverything)
 	.attr("width", barWidth)
 	.attr("height", checkHeight(length("Yellow") * scaleBars))
   ...
   g.append("rect")
 	...
 	.attr("y", height - checkHeight(length("Orange") * scaleBars)  - moveEverything)
 	.attr("width", barWidth)
 	.attr("height", checkHeight(length("Orange") * scaleBars))
   ...
   g.append("rect")
 	...
 	.attr("y", height - checkHeight(length("Red") * scaleBars)  - moveEverything)
 	.attr("width", barWidth)
 	.attr("height", checkHeight(length("Red") * scaleBars) )
