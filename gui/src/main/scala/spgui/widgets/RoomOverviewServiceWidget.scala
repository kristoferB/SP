...
object RoomOverviewServiceWidget {
  ...
  val width = 1371.01                    	// Kroppens bredd
  val height = (1080/1372.01) * width    	// Kroppens höjd
  val smallRec = (83.1/1372.01) * width  	// Höjd samt bredd, små rektanglar
  val barDistance = (6.8/1372.01) * width

  val sizeNumbers = "30px"
  val sizeText = "32px"
  ...
  // -------- TEXTER ----------
  svg.append("text")
    .attr("x", (20.5/1372.01)*width)
    .attr("y", (442.5/1372.01)*width)
  ...
  svg.append("text")
    .attr("x", (75/1372.01)*width  + smallRec)
    .attr("y", (442.5/1372.01)*width + smallRec)
    .attr("font-size", sizeText)
    .text("Triage")
    .attr("fill", blackNumbers)
    .style("font-weight", "bold")
  ...
  svg.append("text")
    .attr("x", (410/1372.01)*width)
    .attr("y", (170/1372.01)*width)
    .attr("font-size", sizeText)
    .text("Medicin Gul")
    .attr("fill", blackNumbers)
    .style("font-weight", "bold")
  ...
  svg.append("text")
    .attr("x", (860/1372.01)*width)
    .attr("y", (260/1372.01)*width)
    .attr("font-size", "22px")
    .text("ÖNH")
    .attr("fill", blackNumbers)

  svg.append("text")
    .attr("x", (980/1372.01)*width)
    .attr("y", (460/1372.01)*width)
    .attr("font-size", sizeText)
    .text("Ortopedi")
    .attr("fill", blackNumbers)
    .style("font-weight", "bold")
  ...
  svg.append("text")
    .attr("x", (486/1372.01)*width)
    .attr("y", (760/1372.01)*width)
    .attr("font-size", sizeText)
    .text("Akutrum")
    .attr("fill", blackNumbers)
    .style("font-weight", "bold")
  ...
  svg.append("text")
    .attr("x", (936/1372.01)*width)
    .attr("y", (740/1372.01)*width)
    .attr("font-size", sizeText)
    .text("Kirurgi")
    .attr("fill", blackNumbers)
    .style("font-weight", "bold")
  ...
  // ----------- INFEKTION -------------
  g.append("rect")
    .attr("x", (45/1372.01)*width )
    .attr("y", (34.1/1372.01)*width)
    .attr("width", smallRec)
    .attr("height", smallRec)
    .attr("fill", checkInfektion(1.toString))

  svg.append("text")
    .attr("x", (45/1372.01)*width + smallRec/2.5)
    .attr("y", (34.1/1372.01)*width + 2*smallRec/3)
  ...
  g.append("rect")
    .attr("x", (45/1372.01)*width)
    .attr("y", (34.1/1372.01)*width + smallRec + barDistance)
    .attr("width", smallRec)
    .attr("height", smallRec)
  ...
  svg.append("text")
    .attr("x", (45/1372.01)*width + smallRec/2.5)
    .attr("y", (34.1/1372.01)*width + 2*smallRec/3 + smallRec + barDistance)
    .attr("font-size", sizeNumbers)
    .text(s"${2}")
  ...
  g.append("rect")
    .attr("x", (45/1372.01)*width)
    .attr("y", (34.1/1372.01)*width + 2*smallRec + 2*barDistance)
    .attr("width", smallRec)
    .attr("height", smallRec)
  ...
  svg.append("text")
    .attr("x", (45/1372.01)*width + smallRec/2.5)
    .attr("y", (34.1/1372.01)*width + 2*smallRec/3 + 2*smallRec + 2*barDistance)
    .attr("font-size", sizeNumbers)
    .text(s"${3}")
  ...
  g.append("rect")
    .attr("x", (45/1372.01)*width)
    .attr("y", (34.1/1372.01)*width + 3*smallRec + 3*barDistance)
    .attr("width", smallRec)
    .attr("height", smallRec)
  ...
  svg.append("text")
    .attr("x", (45/1372.01)*width + smallRec/2.5)
    .attr("y",  (34.1/1372.01)*width + 2*smallRec/3 + 3*smallRec + 3*barDistance)
    .attr("font-size", sizeNumbers)
    .text(s"${4}")
  ...
  svg.append("text")
    .attr("x", (162.9/1372.01)*width + smallRec/2.5)
    .attr("y", (34.1/1372.01)*width + 2*smallRec/3)
    .attr("font-size", sizeNumbers)
    .text(s"${5}")
  ...
  g.append("rect")
    .attr("x", (162.9/1372.01)*width)
    .attr("y", (34.1/1372.01)*width + 4*smallRec + 4*barDistance)
    .attr("width", smallRec)
    .attr("height", smallRec)
  ...
  svg.append("text")
    .attr("x", (162.9/1372.01)*width + smallRec/2.5)
    .attr("y",  (34.1/1372.01)*width + 2*smallRec/3 + 4*smallRec + 4*barDistance)
    .attr("font-size", sizeNumbers)
    .text(s"${9}")
  ...
  svg.append("text")
    .attr("x", (285.9/1372.01)*width + smallRec/4)
    .attr("y", (34.1/1372.01)*width + 2*smallRec/3)
    .attr("font-size", sizeNumbers)
    .text(s"${12}")
  ...
  g.append("rect")
    .attr("x", (280.9/1372.01)*width + smallRec + barDistance)
    .attr("y", (34.1/1372.01)*width)
    .attr("width", smallRec)
    .attr("height", smallRec)
  ...
  svg.append("text")
    .attr("x", (285.9/1372.01)*width + smallRec/4 + smallRec + barDistance)
    .attr("y", (34.1/1372.01)*width + 2*smallRec/3)
    .attr("font-size", sizeNumbers)
    .text(s"${13}")
  ...
  g.append("rect")
    .attr("x", (280.9/1372.01)*width + 2*smallRec + 2*barDistance)
    .attr("y", (34.1/1372.01)*width)
    .attr("width", smallRec)
    .attr("height", smallRec)
  ...
  svg.append("text")
    .attr("x", (285.9/1372.01)*width + smallRec/4 + 2*smallRec + 2*barDistance)
    .attr("y", (34.1/1372.01)*width + 2*smallRec/3)
    .attr("font-size", sizeNumbers)
    .text(s"${14}")
  ...
  g.append("rect")
    .attr("x", (280.9/1372.01)*width + 3*smallRec + 3*barDistance)
    .attr("y", (34.1/1372.01)*width)
    .attr("width", smallRec)
    .attr("height", smallRec)
  ...
  svg.append("text")
    .attr("x", (285.9/1372.01)*width + smallRec/4 + 3*smallRec + 3*barDistance)
    .attr("y", (34.1/1372.01)*width + 2*smallRec/3)
    .attr("font-size", sizeNumbers)
    .text(s"${15}")
  ...
  g.append("rect")
    .attr("x", (280.9/1372.01)*width + 4*smallRec + 4*barDistance)
    .attr("y", (34.1/1372.01)*width)
    .attr("width", smallRec)
    .attr("height", smallRec)
  ...
  svg.append("text")
    .attr("x", (285.9/1372.01)*width + smallRec/4 + 4*smallRec + 4*barDistance)
    .attr("y", (34.1/1372.01)*width + 2*smallRec/3)
    .attr("font-size", sizeNumbers)
    .text(s"${16}")
  ...
  g.append("rect")
    .attr("x", (280.9/1372.01)*width + 4*barDistance + 4*smallRec)
    .attr("y", (34.1/1372.01)*width + smallRec + barDistance)
    .attr("width", smallRec)
    .attr("height", smallRec)
  ...
  svg.append("text")
    .attr("x", (285.9/1372.01)*width + smallRec/4 + 4* barDistance + 4 * smallRec )
    .attr("y", (34.1/1372.01)*width + 2*smallRec/3 + smallRec + barDistance)
    .attr("font-size", sizeNumbers)
    .text(s"${17}")
  ...
  g.append("rect")
    .attr("x", (280.9/1372.01)*width)
    .attr("y", (71.2/1372.01)*width + 3*smallRec + 2*barDistance)
    .attr("width", smallRec)
    .attr("height", smallRec)
  ...
  svg.append("text")
    .attr("x", (285.9/1372.01)*width + smallRec/4)
    .attr("y", (71.2/1372.01)*width + 2*smallRec/3 + 3*smallRec + 2*barDistance)
    .attr("font-size", sizeNumbers)
    .text(s"${27}")
  ...
  g.append("rect")
    .attr("x", (280.9/1372.01)*width)
    .attr("y", (71.2/1372.01)*width + 4*smallRec + 3*barDistance)
    .attr("width", smallRec)
    .attr("height", smallRec)
  ...
  svg.append("text")
    .attr("x", (285.9/1372.01)*width + smallRec/4)
    .attr("y", (71.2/1372.01)*width + 2*smallRec/3 + 4*smallRec + 3*barDistance)
    .attr("font-size", sizeNumbers)
    .text(s"${26}")
  ...
  g.append("rect")
    .attr("x", (280.9/1372.01)*width)
    .attr("y", (71.2/1372.01)*width + 5*smallRec + 4*barDistance)
    .attr("width", smallRec)
    .attr("height", smallRec)
  ...
  svg.append("text")
    .attr("x", (285.9/1372.01)*width + smallRec/4)
    .attr("y", (71.2/1372.01)*width + 2*smallRec/3 + 5*smallRec + 4*barDistance)
    .attr("font-size", sizeNumbers)
    .text(s"${25}")
  ...
  g.append("rect")
    .attr("x", (280.9/1372.01)*width + smallRec + barDistance)
    .attr("y", (103.7/1372.01)*width + 6*smallRec + 4*barDistance)
    .attr("width", smallRec)
    .attr("height", smallRec)
  ...
  svg.append("text")
    .attr("x", (285.9/1372.01)*width + smallRec/4 + smallRec + barDistance)
    .attr("y", (103.7/1372.01)*width + 2*smallRec/3 + 6*smallRec + 4*barDistance)
    .attr("font-size", sizeNumbers)
    .text(s"A4")
  ...
  g.append("rect")
    .attr("x", (759.4/1372.01)*width + smallRec + barDistance)
    .attr("y", (34.1/1372.01)*width)
    .attr("width", smallRec)
    .attr("height", smallRec)
  ...
  svg.append("text")
    .attr("x", (764.4/1372.01)*width + smallRec/4 + smallRec + barDistance)
    .attr("y", (34.1/1372.01)*width + 2*smallRec/3)
    .attr("font-size", sizeNumbers)
    .text(s"${35}")
  ...
  svg.append("text")
    .attr("x", (764.4/1372.01)*width + smallRec/4)
    .attr("y", (34.1/1372.01)*width + 2*smallRec/3)
    .attr("font-size", sizeNumbers)
    .text(s"${34}")
  ...
  g.append("rect")
    .attr("x", (759.4/1372.01)*width)
    .attr("y", (34.1/1372.01)*width + 5*smallRec + 5*barDistance)
    .attr("width", smallRec)
    .attr("height", smallRec)
  ...
  svg.append("text")
    .attr("x", (764.4/1372.01)*width + smallRec/4)
    .attr("y", (34.1/1372.01)*width + 2*smallRec/3 + 5*smallRec + 5*barDistance)
    .attr("font-size", sizeNumbers)
    .text(s"${46}")
  ...
  svg.append("text")
    .attr("x", (972.2/1372.01)*width + smallRec/4)
    .attr("y", (34.1/1372.01)*width + 2*smallRec/3)
    .attr("font-size", sizeNumbers)
    .text(s"${36}")
  ...
  g.append("rect")
    .attr("x", (967.2/1372.01)*width + smallRec + barDistance)
    .attr("y", (34.1/1372.01)*width)
    .attr("width", smallRec)
    .attr("height", smallRec)
  ...
  svg.append("text")
    .attr("x", (972.2/1372.01)*width + smallRec/4 + smallRec + barDistance)
    .attr("y", (34.1/1372.01)*width + 2*smallRec/3)
    .attr("font-size", sizeNumbers)
    .text(s"${37}")
  ...
  g.append("rect")
    .attr("x", (967.2/1372.01)*width + 2*smallRec + 2*barDistance)
    .attr("y", (34.1/1372.01)*width)
    .attr("width", smallRec)
    .attr("height", smallRec)
  ...
  svg.append("text")
    .attr("x", (972.2/1372.01)*width + smallRec/4 + 2*smallRec + 2*barDistance)
    .attr("y", (34.1/1372.01)*width + 2*smallRec/3)
    .attr("font-size", sizeNumbers)
    .text(s"${38}")
  ...
  svg.append("text")
    .attr("x", (1254.1/1372.01)*width + smallRec/12)
    .attr("y", (34.1/1372.01)*width + 2*smallRec/3)
    .attr("font-size", sizeNumbers)
    .text(s"47A")
  ...
  // ---------------------------- KIRURG -----------------------------------------
  g.append("rect")
    .attr("x", (759.4/1372.01)*width + 4*smallRec + 4*barDistance)
    .attr("y", (603.6/1372.01)*width + 4*smallRec + 4*barDistance)
    .attr("width", smallRec)
    .attr("height", smallRec)
    .attr("fill", checkKirg(63.toString))

  svg.append("text")
    .attr("x", (764.4/1372.01)*width + smallRec/4 + 4*smallRec + 4*barDistance)
    .attr("y", (603.6/1372.01)*width + 2*smallRec/3 + 4*smallRec + 4*barDistance)
    .attr("font-size", sizeNumbers)
    .text(s"${63}")
  ...
  g.append("rect")
    .attr("x", (759.4/1372.01)*width + 4*smallRec + 4*barDistance)
    .attr("y", (603.6/1372.01)*width + 3*smallRec + 3*barDistance)
    .attr("width", smallRec)
    .attr("height", smallRec)
  ...
  svg.append("text")
    .attr("x", (764.4/1372.01)*width + smallRec/4 + 4*smallRec + 4*barDistance)
    .attr("y", (603.6/1372.01)*width + 2*smallRec/3 + 3*smallRec + 3*barDistance)
    .attr("font-size", sizeNumbers)
    .text(s"${62}")
  ...
  g.append("rect")
    .attr("x", (759.4/1372.01)*width + 4*smallRec + 4*barDistance)
    .attr("y", (603.6/1372.01)*width + 2*smallRec + 2*barDistance)
    .attr("width", smallRec)
    .attr("height", smallRec)
  ...
  svg.append("text")
    .attr("x", (764.4/1372.01)*width + smallRec/4 + 4*smallRec + 4*barDistance)
    .attr("y", (603.6/1372.01)*width + 2*smallRec/3 + 2*smallRec + 2*barDistance)
    .attr("font-size", sizeNumbers)
    .text(s"${61}")
  ...
  g.append("rect")
    .attr("x", (759.4/1372.01)*width + 4*smallRec + 4*barDistance)
    .attr("y", (603.6/1372.01)*width + smallRec + barDistance)
    .attr("width", smallRec)
    .attr("height", smallRec)
  ...
  svg.append("text")
    .attr("x", (764.4/1372.01)*width + smallRec/4 + 4*smallRec + 4*barDistance)
    .attr("y", (603.6/1372.01)*width + 2*smallRec/3 + smallRec + barDistance)
    .attr("font-size", sizeNumbers)
    .text(s"${60}")
  ...
  g.append("rect")
    .attr("x", (759.4/1372.01)*width + 5*smallRec + 5*barDistance)
    .attr("y", (603.6/1372.01)*width)
    .attr("width", smallRec)
    .attr("height", smallRec)
    .attr("fill", checkKirg(59.toString))

  svg.append("text")
    .attr("x", (764.4/1372.01)*width + smallRec/4 + 5*smallRec + 5*barDistance)
    .attr("y", (603.6/1372.01)*width + 2*smallRec/3)
    .attr("font-size", sizeNumbers)
    .text(s"${59}")
  ...
  g.append("rect")
    .attr("x", (759.4/1372.01)*width + 3*smallRec + 3*barDistance)
    .attr("y", (603.6/1372.01)*width)
    .attr("width", smallRec)
    .attr("height", smallRec)
  ...
  svg.append("text")
    .attr("x", (764.4/1372.01)*width + smallRec/4 + 3*smallRec + 3*barDistance)
    .attr("y", (603.6/1372.01)*width + 2*smallRec/3)
    .attr("font-size", sizeNumbers)
    .text(s"${57}")
  ...
  g.append("rect")
    .attr("x", (759.4/1372.01)*width + 2*smallRec + 2*barDistance)
    .attr("y", (603.6/1372.01)*width)
    .attr("width", smallRec)
    .attr("height", smallRec)
  ...
  svg.append("text")
    .attr("x", (764.4/1372.01)*width + smallRec/4 + 2*smallRec + 2*barDistance)
    .attr("y", (603.6/1372.01)*width + 2*smallRec/3)
    .attr("font-size", sizeNumbers)
    .text(s"${56}")
