...
object OrthopedyTriageWidget {
    ...
    val messObs = BackendCommunication.getMessageObserver(
      mess => {
        mess.getBodyAs[api.PatientProperty] map {
          ...
          case x => println(s"THIS WAS NOT EXPECTED IN OrthopedyTriageWidget: $x")
        }
  ...
  private val component = ReactComponentB[Unit]("TeamBelastningWidget")
  .initialState(Map("-1" ->
    Patient(
      "4502085",
  ...
  /**
  * Checks if the patient belongs to this team. HERE: Ortopedi.
  */
