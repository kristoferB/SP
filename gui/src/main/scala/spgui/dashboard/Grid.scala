...
object ReactGridLayout {
  ...
  case class Props(
    ...
    cols: js.UndefOr[js.Object] = js.Dynamic.literal("lg" -> 24, "md" -> 16, "sm" -> 12, "xs" -> 8, "xxs" -> 4),
    ...
    containerPadding: js.UndefOr[js.Array[Int]] = js.Array(2,2),
    rowHeight: js.UndefOr[Int] = 50,
    isDraggable: js.UndefOr[Boolean] = true,
    isResizable: js.UndefOr[Boolean] = true,
