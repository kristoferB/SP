...
//                      val data:     GoogleVisualization.DataTable,
//                      val timeline: GoogleVisualization.Timeline,
...
//  private def preDefTimelineData: GoogleVisualization.DataTable = {
//    val toInit = new GoogleVisualization.DataTable()
...
//
//  def apply(
//             dataTable: GoogleVisualization.DataTable,
//             timeline: GoogleVisualization.Timeline,
...
//    new GoogleVisualization.Timeline(element),
//    // set the options
//    options
//  )
//
...
//    new GoogleVisualization.DataTable(jsonData),
//    // create a new GoogleVisualization.Timeline() with the given element as argument
//    new GoogleVisualization.Timeline(element),
