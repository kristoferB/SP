...
(function () {
    ...
    angular
      .module('app.EdsWidget')
      .controller('EdsWidgetController', EdsWidgetController);

    EdsWidgetController.$inject = ['$scope', 'dashboardService', 'eventService','spServicesService'];
    /* @ngInject */
    function EdsWidgetController($scope, dashboardService, eventService,spServicesService) {
        var vm = this;
