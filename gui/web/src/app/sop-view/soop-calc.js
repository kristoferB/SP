    ...
    angular
        .module('app.sopView')
        .service('soopCalc', soopCalc);

    soopCalc.$inject = ['itemService'];
    /* @ngInject */
    function soopCalc(itemService) {
        var service = {
        ...
        function getWidth(sop, measures, dirScope, firstLaunch) {
            ...
            // Creating an empty object in each node to gather all additions made by soopCalc and sopDrawer
