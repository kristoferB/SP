...
(function () {
    ...
    angular
      .module('app.sequenceViewerWidget')
      .controller('sequenceViewerController', sequenceViewerController);

    sequenceViewerController.$inject = ['$scope', 'dashboardService', 'eventService'];
    /* @ngInject */
    function sequenceViewerController($scope, dashboardService, eventService) {
        var vm = this;
