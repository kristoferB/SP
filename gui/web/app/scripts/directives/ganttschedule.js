          ...
          return {
            "data1": [
              ...
              {"id": "2f85dbeb-0845-404e-934e-218bf39750c0", "description": "o1", "order": 0, "tasks": [
                ...
                {"id": "f55549b5-e449-4b0c-9f4b-8b33381f7d76", "color": "#ebebeb", "from": new Date(2014,9,23,0,0,0), "to": new Date(2014,9,23,5,0,0), "data": "Can contain any custom data or object"}
              ], "data": "Can contain any custom data or object"},
              {"id": "b8d9927-cf50-48bd-a056-3554decab824", "description": "o2", "order": 1, "tasks": [
                {"id": "301d781f-1ef0-4c35-8398-478b641c0658", "color": "#ebebeb", "from": new Date(2014,9,23,3,0,0), "to": new Date(2014,9,23,11,0,0)}
              ]},
              {"id": "c65c2672-445d-4297-a7f2-30de241b3145", "description": "o3", "order": 2, "tasks": [
                {"id": "4e197e4d-02a4-490e-b920-4881c3ba8eb7", "color": "#ebebeb", "from": new Date(2014,9,23,3,0,0), "to": new Date(2014,9,23,11,0,0)}
              ]},
              {"id": "dd2e7a97-1622-4521-a807-f29960218785", "description": "o4", "order": 3, "tasks": [
                {"id": "9c17a6c8-ce8c-4426-8693-a0965ff0fe69", "color": "#ebebeb", "from": new Date(2014,9,23,15,0,0), "to": new Date(2014,9,23,23,0,0)}
              ]}
            ]};
        }
